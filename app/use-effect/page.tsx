    ...
    return (
        <div>
            ...
            <div className=" bg-pink-200 text-center p-4">
                <h1 className="text-6xl text-center ibm-plex-sans-thai-bold  text-black">
                    UseEffect
                </h1>
                ...
                <div className="justify-items-center p-4">
                    {movieList.filter((item: { media_type?: string }) => item.media_type === "tv").map(
                        (
                            item: {
                                title?: string;
                                name?: string;
                            ...
                            <div className="p-4 w-100 bg-pink-300">
